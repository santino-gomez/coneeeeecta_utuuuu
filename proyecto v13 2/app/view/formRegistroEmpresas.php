<form action="../../app/controller/regisController.php" method="POST" class="formRegistro">
...
<form action="" class="formRegistro">
    ...
    <span class="contenido1" style="margin-left: 60px; margin-right: 60px;">
        ...
        <p> ¿Todavía no registraste tu empresa? <br>
        <a href="registrarse.php" style="color: #7865e4; text-decoration: underline;">Registra tu empresa acá</a>
    </p>
